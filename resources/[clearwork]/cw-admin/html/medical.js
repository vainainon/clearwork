(function () {
    ...
    function injectCharacterSettingsPanel() {
        ...
        panel.innerHTML = `
            ...
            <div class="medical-row">
                ...
                <span>%</span>
                <button id="medicalChanceSave">Сохранить</button>
                <button id="medicalChanceRefresh">Обновить</button>
            </div>
    ...
    function addReviveButtonsToCharacters() {
        ...
        cards.forEach((card, index) => {
            ...
            button.textContent = 'Оживить персонажа';
            button.className = 'medical-revive-btn';
